export const chats = [
  {
    id: '0',
    name: 'Maty (tú)',
    avatar: '../../../avatars/Auto.jpg',
    messages: [
      { from: 'me', text: 'Tutoria viernes/sabados 9hs', time: '8:17 a. m.' },
      { from: 'me', text: 'Terminar tp final Curso', time: '9:52 a. m.' },
      { from: 'me', text: 'Poner pollo en el horno', time: '10:12 a. m. ' },
      { from: 'me', text: 'Ir a comprar pan', time: '15:28 p. m.' },
      { from: 'me', text: 'Ir a buscar el auto', time: '18:20 p. m.' },
      { from: 'me', text: 'Alimentar perro del vecino', time: '00:20 a. m.' }
    ]
  },

  {
    ...
    messages: [
      ...
      { from: 'them', text: 'En 15m llego a casa, pone el pollo en el horno', time: '10:03 a. m.' },
      { from: 'me', text: 'Dale ma, ahi voy', time: '10:05 a. m.' }
    ]
  },
  {
    id: '2',
  ...
  },
  {
    ...
    messages: [
      ...
      { from: 'them', text: 'Hola maty, mañana ya lo tenes', time: '10:02 a. m.' },
    ...
    avatar: 'https://i.pravatar.cc/150?img=20',
    messages: [
      { from: 'me', text: 'Cuando hacemos algo?', time: '13:50 p. m.' },
      { from: 'them', text: 'el miercoles podes?', time: '14:02 p. m.' },
      { from: 'them', text: 'Salgo temprano del laburo, vamos a merendar', time: '14:03 p. m.' },
      { from: 'me', text: 'Dale, no hay drama', time: '14:10 p. m.' },
      { from: 'me', text: 'Justo tengo el auto mañana, te paso a buscar ❤', time: '14:10 p. m.' },
    ...
    messages: [
      ...
      { from: 'them', text: 'Te puedo, pedir un favor?', time: '22:02 p. m.' },
      { from: 'me', text: 'Si, decime', time: '22:05 p. m.' },
      { from: 'them', text: 'Voy a estar una semana en brasil', time: '22:07 p. m.' },
      { from: 'them', text: 'Y por temas de transporte, no pude llevar a mi perro conmigo', time: '22:07 p. m.' },
      { from: 'them', text: 'Queria ver si podrias alimentarlo por mi', time: '22:08 p. m.' },
      { from: 'them', text: 'Hay una llave abajo de la alfombra y la comida esta en el living', time: '22:09 p. m.' },
      { from: 'them', text: 'Come 2 veces por dia, Mañana y noche. Puedo contar con vos? ', time: '22:09 p. m.' },
      { from: 'me', text: 'No hay problema vecino, ahi estaré', time: '22:15 p. m.' },
      { from: 'me', text: 'Buen viaje! 💥', time: '22:15 p. m.' },
    ]
  },
];
